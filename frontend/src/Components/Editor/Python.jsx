...
function Python() {
  ...
  const handleSubmit = async ()=>{
    ...
    try{
      ...
      // const {data} = await axios.post("https://codo-file-backend-76cx.onrender.com/runpy",payload)
      const response = await fetch("https://codo-file-backend-76cx.onrender.com/runpy",{
        method:'POST',
        headers:{
