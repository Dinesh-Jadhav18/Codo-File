...
function Register() {
  ...
  const PostData = async (e) => {
    ...
    const res = await fetch(
      "https://codo-file-backend-76cx.onrender.com/register",
      {
        method: "POST",
        headers: {
            ...
            <form>
              <div className="RegisterInputField">
                ...
                <div className="Registeremail">
                  <label className="registerLabels" htmlFor="email">
                    Email:
                  </label>
                  <br />
                  <input
                ...
                <div className="Registerpassword">
                  <label className="registerLabels" htmlFor="pass">
                    Password:
                  </label>
                  <br />
                  <input
                ...
                <div className="Registercpassword">
                  <label className="registerLabels" htmlFor="cpass">
                    Confirm Password:
                  </label>
                  <br />
                  <input
                ...
                <div className="Registerdomain">
                  <label className="registerLabels" htmlFor="work">
                    Profession:
                  </label>
                  <input
                    type="text"
